        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              animate="open"
              exit="closed"
              className="fixed right-0 top-20 bottom-0 w-[300px] bg-slate-900 shadow-xl md:hidden"
            >
              <nav className="flex flex-col divide-y divide-slate-800">
                {menuItems.map((item, index) => (
                  ...
                  >
                    <a
                      href={item.href}
                      className="block py-4 px-6 text-lg font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors"
                    >
                      {item.label}
                    </a>
                  </motion.div>
